                ...
                <div class="container-fluid">
                  <div class="row">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <center>
                            <div class="form-group">
                              <span class="badge badge-primary h1" id="abc"> Step 3 / 5 </span>
                            </div>
                          </center>
                    </div>
                  </div>
                    <!-- your steps content here -->
                      <div class="form-group">
                        <label for="check_phone" class="float-left">Phone</label>
                        <input type="text" name="check_phone" class="form-control" id="check_phone" placeholder="Enter Mob #"
                        data-inputmask='"mask": "(9999) (9999999)"' data-mask>
                      </div>
                      <button class="btn btn-primary float-left" name="btn_back"
                       type="submit">
                      <i class="fas fa-angle-left"></i>&nbsp; Previous</button>
                      <button class="btn btn-primary float-right" type="submit" name="btn_check_phone">Next &nbsp;<i class="fas fa-angle-right"></i></button>
                      <br><br>
              </div>
            </div>
              </form>
...
if(isset($_POST['btn_check_phone'])){
  if($_POST['check_phone'] != "" or $_POST['check_phone'] != null){
    ...
    $sql2="select * from `registred_lecturers` where `email`='$email' 
    and `phone`='$check_phone'";
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              ...
              <p>Your phone did not matching with original phone #</p>
              <button type="button" style="font-size: 50px;" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </div>
          </div>
