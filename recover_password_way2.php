                ...
                <div class="container-fluid">
                  <div class="row">
                    ...
                    <!-- your steps content here -->
                      <div class="form-group">
                        <label for="check_email" class="float-left">Enter Email Address</label>
                        <input type="text"v name="check_email" class="form-control" id="check_email" placeholder="email address">
                      </div>
                      <button class="btn btn-primary float-right" type="submit" id="btn-step-1" name="btn_check_email">Next &nbsp;<i class="fas fa-angle-right"></i></button>
                      <br><br>
              </div>
            </div>
              </form>
...
if(isset($_POST['btn_check_email'])){
  if($_POST['check_email'] != "" or $_POST['check_email'] != null){
  ...
  $sql2="select * from `registred_lecturers` where `email`='$check_email'";
  $run2=mysqli_query($cn,$sql2);

    if(mysqli_num_rows($run)>0){
      mysqli_close($cn);
      header("location:step2.php?email=$check_email");
