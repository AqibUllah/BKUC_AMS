                        ...
                        <div class="input-group mb-3">
                          ...
                          <center>
                            <div class="form-group">
                              <span class="badge badge-primary h1" id="abc"> Step 4 / 5 </span>
                            </div>
                          </center>
                    </div>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="callout callout-info bg-primary">
                                <strong class="h5 float-left"><i class="fas fa-info-circle"></i> Attention</strong><br><br>
                                <p style="color: white;">We just send you verification code through email please check your email and enter the code for verified your email. &nbsp;<i>if is'nt recieved</i>
                                  <input type="submit" name="btn_resend" 
                                  class="btn btn-danger" value="Resend"></p>
                            </div>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="v_code" class="float-left">Enter Verificatino Code</label>
                        <input type="text"v name="v_code" class="form-control" id="v_code" placeholder="verification code">
                      </div>
                      <button class="btn btn-primary float-left" type="submit"
                      name="btn_back">
                      <i class="fas fa-angle-left"></i>&nbsp; Previous</button>
                      <button class="btn btn-primary float-right" type="submit" name="btn_check_code">Next &nbsp;<i class="fas fa-angle-right"></i></button>
                      <br><br>
              </div>
            </div>
              </form>
              ...
              <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="alert alert-maroon bg-maroon alert-dismissible fade show" role="alert">
                    <div class="h1">Oops ! <i class="fas fa-times-circle fa-sm"></i></div>
...
if(isset($_POST['btn_check_code'])){
    if($_POST['v_code'] != "" or $_POST['v_code']!= null){
      $verif_code = $_POST['v_code'];
      include('db_page_2.php');
      $cn=db_connection();
      $sql="SELECT * FROM  `pass_verif_codes` WHERE `email`='$email'";
      $get=mysqli_query($cn,$sql);
      if($get){
        while ($get_code=mysqli_fetch_assoc($get)) {
                $code=$get_code['code'];
        }
        mysqli_close($cn);
      }
      if($verif_code == $code){
        header("location:step5.php?email=$email");
      }else{
        ?>
        <div class="row">
          <div class="col-lg-2 col-md-2 col-sm-2"></div>
          <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              <div class="h1">Error <i class="fas fa-exclamation-triangle fa-sm"></i></div>
              <p>Verification code Did not matching</p>
              <button type="button" style="font-size: 50px;" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </div>
          </div>
        ...
        //again sending  mail
                  $to = $email;
                  $subject = "REGARDING : Critical Situation";
                  $headers="From: BKUC AMS";
                  $message="<html><body>";
                  $message.="<div style='max-width: 600px;min-width: 200px;background-color: #fff;padding: 20px;margin: auto';>
                  <center><img style='max-height: 75px;' src='https://www.bkuc.edu.pk/public/images/top_banner1.png'></a></center>
                  <h3>BKUC ASSIGMENT MANAGEMENT SYSTEM</h3>
                  <strong>Dear AMS User Your Account Is In Problem</strong>
                  <p>Some one is trying to change your password</p>
                  <p><i><strong>you need to change your password immediatly.</strong></i></p>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8 col-sm-8">
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
              ...
              <p>Please Enter Verficication Code</p>
              <button type="button" style="font-size: 50px;" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </div>
          </div>
